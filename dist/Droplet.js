...
function SvgDroplet(passedProps, svgRef) {
    ...
    return (React.createElement(react_native_svg_1.default, __assign({ width: "1.5em", height: "1.5em", viewBox: "0 0 24 24", strokeWidth: 1.5, fill: "none", color: "currentColor", ref: svgRef }, props),
        React.createElement(react_native_svg_1.Path, { d: "M20 14c0-4.418-8-12-8-12S4 9.582 4 14a8 8 0 1016 0z", stroke: "currentColor" })));
}
var ForwardRef = React.forwardRef(SvgDroplet);
