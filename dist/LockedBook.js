...
function SvgLockedBook(passedProps, svgRef) {
    ...
    return (React.createElement(react_native_svg_1.default, __assign({ width: "1.5em", strokeWidth: 1.5, height: "1.5em", viewBox: "0 0 24 24", fill: "none", color: "currentColor", ref: svgRef }, props),
        ...
        React.createElement(react_native_svg_1.Path, { d: "M14 10h.4a.6.6 0 01.6.6v2.8a.6.6 0 01-.6.6H9.6a.6.6 0 01-.6-.6v-2.8a.6.6 0 01.6-.6h.4m4 0V8c0-.667-.4-2-2-2s-2 1.333-2 2v2m4 0h-4", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }),
...
var ForwardRef = React.forwardRef(SvgLockedBook);
